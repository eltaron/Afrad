            ...
            <div class="bg-white dark:bg-themeBlue-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-blue-100">
                    <div class="mb-4 flex justify-end">
                        <a href="{{ route('admin.leave-types.create') }}" class="bg-themeBlue-600 hover:bg-themeBlue-500 dark:bg-themeBlue-500 dark:hover:bg-themeBlue-400 text-white font-bold py-2 px-4 rounded">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-themeBlue-700">
                            <thead class="bg-gray-50 dark:bg-themeBlue-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 dark:text-blue-200 uppercase tracking-wider">{{ __('validation.attributes.default_days') }}</th>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 dark:text-blue-200 uppercase tracking-wider">{{ __('validation.attributes.applies_to') }}</th>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 dark:text-blue-200 uppercase tracking-wider">{{ __('validation.attributes.is_permission') }}</th>
                            ...
                            <tbody class="bg-white dark:bg-themeBlue-900 divide-y divide-gray-200 dark:divide-themeBlue-700">
                                @forelse ($leaveTypes as $leaveType)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-themeBlue-800">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-blue-100">{{ $leaveType->id }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-blue-200">{{ $leaveType->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-blue-200">{{ $leaveType->default_days }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-blue-200">{{ $leaveType->applies_to }} {{ $leaveType->specific_rank_or_title ? '('.$leaveType->specific_rank_or_title.')' : ''}}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-blue-200">{{ $leaveType->is_permission ? __('app.yes') : __('app.no') }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500 dark:text-blue-200">
