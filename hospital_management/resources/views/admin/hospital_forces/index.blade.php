            ...
            <div class="bg-white dark:bg-themeBlue-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-blue-100">
                    <div class="mb-4 flex justify-end">
                        <a href="{{ route('admin.hospital-forces.create') }}" class="bg-themeBlue-600 hover:bg-themeBlue-500 dark:bg-themeBlue-500 dark:hover:bg-themeBlue-400 text-white font-bold py-2 px-4 rounded">
                            ...
                            @forelse ($hospitalForces as $hospitalForce)
                                <tr class="hover:bg-gray-100 dark:hover:bg-themeBlue-800">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.hospital-forces.show', $hospitalForce) }}" class="text-themeBlue-600 dark:text-themeBlue-400 hover:text-themeBlue-900 dark:hover:text-themeBlue-200 me-3">{{ __('app.details') }}</a>
