...
@section('header')
    <h2 class="font-semibold text-xl text-gray-800 dark:text-blue-100 leading-tight">
        {{ __('app.edit') }} {{ __('app.department') }}: {{ $department->getTranslation('name', 'ar') }}
    </h2>
@endsection
                    ...
                    <form action="{{ route('admin.departments.update', $department->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name_ar" id="name_ar"
                                   value="{{ old('name_ar', $department->getTranslation('name', 'ar')) }}"
                        ...
                        {{-- <div class="mb-4">
                            ...
                            <input type="text" name="name_en" id="name_en"
                                   value="{{ old('name_en', $department->getTranslation('name', 'en')) }}"
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.departments.index') }}" class="text-sm text-gray-600 dark:text-blue-300 hover:text-gray-900 dark:hover:text-blue-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-themeBlue-800 me-4">
                                {{ __('app.cancel') }}
                            </a>
